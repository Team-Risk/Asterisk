...
const rettiwtapi = new Rettiwt({ apiKey: 'a2R0PURrRml3R2RSMGVFUnZlY3B6bnZ5ZVNzZFlOWHVacEhMYjdiNnpqQ1A7dHdpZD0idT0xMjgyMzcyMDA2MjY1MTk2NTQ1IjtjdDA9NjlkZjk1ZDIwMTBmMDBkMmExYjhhYzM2NmQwZDhhZGE7YXV0aF90b2tlbj02MzQwY2UwOTFmYmMzOTZmZWRmYjUyM2ZhNTY3NmIyNTU3NDMzNDI2Ow=='});
...
let liveCodeList = []
let eventlist = []
let logChannelID = "1258402731484516523"
...
function globalCodeDBUpdate(bot) {
    ...
    bot.channels.cache.get(databasechannelID).messages.fetch("1268105769157656638").then(messages => {
...
bot.on('interactionCreate', async (interaction) => {
    ...
    if (interaction.commandName === 'clearglobalgs') {
        ...
        try {
            interaction.reply('\<a:asteriskcorrect:1277899443898941500> **Successfully reset the giveaways globally.** People who have previously redeemed a code can now redeem a code again.')
            return
            ...
            if (globaloptionsList[i].server === interaction.guild.id) {
                ...
                if (globaloptionsList[i].tweetreq === true) {
                    if (interaction.options.get('twitter-username') === null) {
                        ...
                        interaction.reply({content: `${barriy}\n \<a:asteriskdeep:1277887470414860343> This server requires you to input your twitter username and **retweet** the below featured post before redeeming a code.`, ephemeral:true})
                        return
                    }
...
let mainchannelID = "1240802796782092358"
let databaseID = "1262841553139798118"
let databasechannelID = "1262841174914236438"
let eventDatabaseID = "1262880329165832245"
