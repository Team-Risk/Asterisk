...
var Tweet = /** @class */ (function () {
    ...
    function Tweet(tweet) {
        ...
        this.retweetedTweet = ((_d = (_c = tweet.legacy.retweeted_status_result) === null || _c === void 0 ? void 0 : _c.result) === null || _d === void 0 ? void 0 : _d.rest_id)
    ...
    Tweet.list = function (response) {
        ...
        for (var _i = 0, extract_1 = extract; _i < extract_1.length; _i++) {
            ...
            if ((_b = (_a = item.tweet_results) === null || _a === void 0 ? void 0 : _a.result) === null || _b === void 0 ? void 0 : _b.legacy) {
                // Logging
